...
import Worker.DocuNode;
import Worker.IndexNode;
import Worker.MergeAndSort;
...
public class Combiner{
    ...
    public Combiner(Vector<String> inputFiles0){
        System.out.println(inputFiles0);
        inputFiles = inputFiles0;
        outputFilenames = new ArrayList<String>();
        outputFilePrefix = "C:\\MiniGoogle\\combiner\\";
    }
